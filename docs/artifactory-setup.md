# JFrog Artifactory Setup and Integration

This document explains how to configure JFrog Artifactory for Docker image publishing in repositories created from this template.
...
2. Look for the "CI/CD Pipeline" workflow run
3. Verify the "Build and push Docker image" step completes successfully

## Local Development and Testing

Before pushing to GitHub, you can test the application locally:
...
For more detailed development instructions, see the [Development Guide](development.md).
